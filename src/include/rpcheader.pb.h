...
namespace mprpc {
class RpcHeader;
struct RpcHeaderGlobalsTypeInternal;
#ifndef PROTOBUF_MESSAGE_GLOBALS
extern RpcHeaderGlobalsTypeInternal RpcHeader_globals_;
extern const ::google::protobuf::internal::ClassDataFull RpcHeader_class_data_;
#else
extern const RpcHeaderGlobalsTypeInternal RpcHeader_globals_;
...
/* @@protoc_insertion_point(class_definition:mprpc.RpcHeader) */ {
 public:
  ...
  inline RpcHeader(RpcHeader&& from) noexcept : RpcHeader(nullptr, ::std::move(from)) {}
  ...
  [[nodiscard]] static const RpcHeader& default_instance() {
    return *::google::protobuf::internal::MessageGlobalsBase::ToDefaultInstance<RpcHeader>(&RpcHeader_globals_);
  }
